...
1. Female Epigrapghy patterns from the AIO data base
 
2. Male Epighrapghy patterns from the AIO data base. Both are included within the notebook to allow viewers to compare and contrast the findings. Such findings are further developed within the required essay for the project.
...
1. JSON Code
2. XML Code
3. Excel Graph and data link
5. Recogito Link
6. Recogito Corpus companion Link 

*-Voyant tools* 
1. Voyant Tools Spyral Notebook
